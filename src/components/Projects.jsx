  ...
  return (
    <div className={style.container} id="Projects">
      ...
      <div className={style.projects}>
        ...
        <a href="https://github.com/lorena-rosati/REACTive-todo-list.git" target="_blank" rel="noreferrer"><Project src={todoapp} title="To-Do List App" tools="JavaScript, React, Firebase (Cloud Firestore), Tailwind CSS" description="A dynamic to-do list app with CRUD functionality (create, read, update, and delete) that stores user data using Cloud Firestore database software." /></a>
